...
namespace ParqueFerroviarioAlberto.Controllers
{
    public class EstadoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idEstado,ubicacion,estatus,idCiudad")] Estado estado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idEstado,ubicacion,estatus,idCiudad")] Estado estado)
        {
            if (ModelState.IsValid)
            {
